...
<head>
    ...
    <link rel = "stylesheet" href = "vista/CSS/booking.css?version=<?php echo time(); ?>">
</head>
<body>
<?php if (isset($_GET['mensaje'])): ?>
    ...
    <div class="container">
        ...
        <div class="formulario">
            <form id="nuevareservaeaForm" action="controlador/agregar_reservaea.php" method="post" enctype="multipart/form-data">
                ...
                <label for="excursions"><b class="textoA">Excursión</b></label>
                <select name="excursion" id="excursion" onchange="fillPackageData()" required>
                    <option value="" selected disabled>Seleccione una excursión</option>
    ...
    <script src="JS/reservaseacliente.js"></script>
    <script src="vista/JS/reservas_calendario.js"></script>
    <script src="vista/JS/reservas_precios.js"></script>
</body>
</html>