    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body custom-scroll">
                <form id="editarForm" action="./controlador/editar_reservaea.php" method="post" enctype="multipart/form-data">
                <input type="hidden" id="id_reservaea_editar" name="id_reservaea_editar">
