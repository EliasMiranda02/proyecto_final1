    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body custom-scroll">
                <form id="editarForm" action="./controlador/editar_rentacarro.php" method="post" enctype="multipart/form-data">
                <input type="hidden" id="id_rentacarro_editar" name="id_rentacarro_editar">
