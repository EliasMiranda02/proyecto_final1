    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body custom-scroll">
                <form id="editarForm" action="./controlador/editar_reservapv.php" method="post" enctype="multipart/form-data">
                <input type="hidden" id="id_reservapv_editar" name="id_reservapv_editar">
