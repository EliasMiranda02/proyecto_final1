...
if ($conexion->query($sql) === TRUE) {
    header('Location: ../index.php?i=reservapvusuario&mensaje=registro_exitoso');
} else {
    header('Location: ../index.php?i=reservapvusuario&mensaje=error&detalle=' . $conexion->error);
}
