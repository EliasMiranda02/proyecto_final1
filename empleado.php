    ...
    <div class="btn-group" role="group" aria-label="Button group with nested dropdown">
        ...
        <div class="btn-group" role="group">
            ...
            <ul class="dropdown-menu">
                <li>
                    <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#Administradores">
                        Launch demo modal
                    </button>
                </li>
                <li>
        ...
        <!-- Modal -->
        <div class="modal" id="Administradores" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
