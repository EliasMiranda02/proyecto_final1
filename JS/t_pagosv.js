document.getElementById('searchFormPagov').addEventListener('submit', function(e) {
    e.preventDefault();
    ...
    fetch('controlador/buscar_pagov.php', {
        method: 'POST',
        body: formData
    })
    .then(response => response.text())
    .then(data => {
        const tbody = document.querySelector('#Pagosv table tbody'); // Especifica el tbody correcto
