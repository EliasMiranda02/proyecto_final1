document.getElementById('searchFormPagoPV').addEventListener('submit', function(e) {
    e.preventDefault();
    ...
    fetch('controlador/buscar_pagopv.php', {
        method: 'POST',
        body: formData
    })
    .then(response => response.text())
    .then(data => {
        const tbody = document.querySelector('#Pagospv table tbody'); // Especifica el tbody correcto
