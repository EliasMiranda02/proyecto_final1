document.getElementById('searchFormPagospa').addEventListener('submit', function(e) {
    e.preventDefault();
    ...
    fetch('controlador/buscar_pagospa.php', {
        method: 'POST',
        body: formData
    })
    .then(response => response.text())
    .then(data => {
        const tbody = document.querySelector('#Pagospa table tbody'); // Especifica el tbody correcto
